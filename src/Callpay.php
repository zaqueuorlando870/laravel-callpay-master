...
use Zaqueuorlando870\Callpay\Exceptions\IsNullException;
use Zaqueuorlando870\Callpay\Exceptions\PaymentVerificationFailedException;
...
class Callpay
{
    ...
    {
        $this->username = Config::get('callpay.username');
        $this->password = Config::get('callpay.password');
    ...
    { 
        $authBearer = 'Authorization: Basic ' . $this->setKey();
     ...
     * Initiate a payment request to Callpay
